...
import {PropertyDemandService} from "../../home/services/property-demand.service";
...
@Component({
    templateUrl: './demand-register.component.html'
})
export class DemandRegisterComponent implements OnInit {
    ...
    startLists() {
        ...
        this.addressService.getAllStatesBasic().subscribe(states =>
    ...
    save() {
        this.submited = true;
        this.propertyDemandService.saveNewDemand(this.propertyForm.value)
    }

    filterCities(event: any) {
        this.addressService.getFilteredCitiesBasic(event.value).subscribe(cities =>
